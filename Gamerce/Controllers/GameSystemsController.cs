    ...
    public class GameSystemsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var gameSystem = await _context.GameSystems
                .SingleOrDefaultAsync(m => m.GameSystemID == id);
            if (gameSystem == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("GameSystemID,ProductSystem")] GameSystem gameSystem)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var gameSystem = await _context.GameSystems.SingleOrDefaultAsync(m => m.GameSystemID == id);
            if (gameSystem == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GameSystemID,ProductSystem")] GameSystem gameSystem)
        {
